...
Deep learning-based system for classifying plant diseases across 38 categories using MobileNetV2 with over 92% accuracy.

### 📚 Book Recommendation System

Collaborative filtering recommendation engine using user ratings and cosine similarity.
